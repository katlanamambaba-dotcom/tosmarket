...
router.post('/guest',async(req,res)=>{
  ...
  const {rows}=await db.query(`INSERT INTO messages(customer_name,customer_email,subject,body,direction,thread_id,is_read,guest_token) VALUES('Ziyaretçi',NULL,$1,$2,'inbound',$3,FALSE,$4) RETURNING id`,[String(subject).slice(0,255),String(body).trim(),threadId,token]);
