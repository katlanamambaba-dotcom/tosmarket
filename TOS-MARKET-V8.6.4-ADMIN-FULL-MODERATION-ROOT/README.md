# TOS MARKET 8.6 — Final Account & Auth
...
Üretimde kayıt ve şifre sıfırlama için SMTP gereklidir:
...
API anahtarlarını veya SMTP şifresini sohbete yazmayın; Render Environment Variables bölümüne girin.
