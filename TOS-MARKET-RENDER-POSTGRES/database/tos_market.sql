...
CREATE TABLE IF NOT EXISTS orders (
  ...
  payment_method VARCHAR(30) NOT NULL DEFAULT 'crypto_email' CHECK (payment_method = 'crypto_email'),
  note TEXT,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
('Özel Dijital Hizmet','Örnek dijital hizmet ilanı.','Hizmet',999,5,'active')
